...
class IpsecProposalAdmin(admin.ModelAdmin):
    list_display = ('id', 'device', 'proposalname', 'authentication_algorithm', 'encryption_algorithm')
    search_fields = ('proposalname', 'authentication_algorithm', 'encryption_algorithm')
